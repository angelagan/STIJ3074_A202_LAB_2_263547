...
require '/home8/doubleks/public_html/PHPMailer/src/SMTP.php';
    ...
    $message = "<p>Click the following link to verify your account<br><br><a href='https://doubleksc.com/fairy_mart/php/verify_account.php?email=".$email."&key=".$otp."'>Verify My Account</a>";
